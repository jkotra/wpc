...
#[allow(dead_code)]
pub async fn wallhaven_wallpaperinfo(apikey: &str, id: &str) -> Result<serde_json::value::Value, Box<dyn std::error::Error>> {
...
#[allow(dead_code)]
pub async fn wallhaven_search(apikey: &str, query: HashMap<&str, &str>) -> Result<Value, Box<dyn std::error::Error>> {
...
// https://wallhaven.cc/help/api#user-settings
#[allow(dead_code)]
pub async fn wallhaven_getid(apikey: &str) -> Result<serde_json::value::Value, Box<dyn std::error::Error>> {
...
#[allow(dead_code)]
pub async fn wallhaven_getcoll(username: &str, collid: &str) -> Result<serde_json::value::Value, Box<dyn std::error::Error>> {
...
#[allow(dead_code)]
pub async fn wallhaven_getcoll_api(username: &str, collid: &str, api_key: &str) -> Result<serde_json::value::Value, Box<dyn std::error::Error>> {
